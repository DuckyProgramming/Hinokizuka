...
game={level:0,zone:2,progress:{zone:0},time:0,player:{size:1},edge:{x:0,y:0},spawn:{x:0,y:0},connections:[],previous:{zone:0},scroll:{x:0,y:0}}
...
inputs={keys:[false,false,false,false,false,false,false],validKey:[true,true,true,true,true,true,true],mouse:{x:0,y:0},rel:{x:0,y:0},pMouse:{x:0,y:0},pRel:{x:0,y:0}}
