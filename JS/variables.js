...
game={level:0,zone:0,progress:{zone:0},time:0,player:{size:1},edge:{x:0,y:0},spawn:{x:0,y:0},connections:[],previous:{zone:0},scroll:{x:0,y:0},players:[0],flowers:0}
...
dev={editor:false,hitbox:false,edge:false,connection:false,markspawn:false,freecam:false,infinitedash:false,invincible:false,nograv:false}