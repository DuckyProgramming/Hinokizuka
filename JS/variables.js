types={
    wall:[
        ...
        {name:'Winged Flower',interval:{x:10,y:10}},
        {name:'Semisolid',interval:{x:10,y:10}},
        {name:'Crystal',interval:{x:10,y:10}},

    ]
}
stage={scene:'main',scale:0}
game={level:1,zone:11,progress:{zone:0},time:0,player:{size:1},edge:{x:0,y:0},spawn:{x:0,y:0},connections:[],previous:{zone:0},scroll:{x:0,y:0},players:[0],flowers:0}
