types={
    wallList:[
        ...
        {name:'Spacial',elements:[69,73,74]},
        ...
        {name:'Crystal - Spacial',interval:{x:[10,0],y:[10,0]},slice:0,clump:0},
        {name:'Collapsing - Spacial',interval:{x:[10,0],y:[10,0]},slice:0,clump:0},
        
    ]
}
stage={scene:'menu',scale:0}
menu={scene:0,transition:0,sceneAnim:[0,0],select:-1,available:[true,true,true,true,true,true,false],complete:[false,false,false,false,false,false,false],selectAnim:[0,0,0,0,0,0,0],levelPos:[[600,540],[300,450],[810,360],[480,270],[660,180],[600,90],[840,90]],playerAnim:[0,0]}
game={level:6,zone:2,progress:{zone:0},time:0,player:{size:1},runTime:0,timeActive:false,
edge:{x:0,y:0},spawn:{x:0,y:0},scroll:{x:0,y:0},wind:{x:0,y:0},iceSwitch:0,
connections:[],previous:{zone:0},players:[0],flowers:0,deaths:0,running:{flowers:0,deaths:0,runTime:0},loadPlan:0,levelData:[]}
